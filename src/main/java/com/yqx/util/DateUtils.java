...
public class DateUtils {
	...
	private static SimpleDateFormat f1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	private static SimpleDateFormat f2 = new SimpleDateFormat("yyyyMMddHHmmss");
	
	private static SimpleDateFormat f3 = new SimpleDateFormat("yyyy-MM-dd");
	private static SimpleDateFormat f4 = new SimpleDateFormat("yyyyMMdd");
	private static SimpleDateFormat f5 = new SimpleDateFormat("HH:mm:ss");
	private static SimpleDateFormat f6 = new SimpleDateFormat("HHmmss");
